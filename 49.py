...
class WeatherApp(QWidget):
    ...
    def get_weather(self):
        api_key = "9fd205208dba75151edd434dc23332b2"
    ...
    def display_weather(self, data):
        ...
        temperature_c = temperature_k * 9 / 5 + 32
        temperature_f = (temperature_k - 273.15) * 9 / 5 + 32
        weather_id = data["weather"][0]["id"]
        print(temperature_k, temperature_c, temperature_f)
    ...
    @staticmethod
        #A static method belongs to a class but don't require any instance specific data or any other methods. They're used as more of a utility tool.
